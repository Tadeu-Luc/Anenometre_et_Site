...
class AWSDriver(weewx.drivers.AbstractDevice):
    ...
    def __init__(self, **stn_dict):
        ...
        try:        
            ...
            logdbg("Connexion avec Arduino effectué.")            

        except Exception, e:
            
            logerr("Erreur de la connexion Arduino ! %s" % e)
    ...
    def parse_readings(self, b):
	  ...
	  The Arduino script emits data in the format:
        ...
        try:
            ...
            data['windDirection'] = float(parts[1])
            data['windCompassDirection'] =float parts[2]
            data['windCalDirection'] =float parts[3]
            data['Windnoeud2'] =float parts[4]  # modifié
